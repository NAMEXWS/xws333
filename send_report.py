...
class DingRobot:
    def __init__(self):
        self.allure = "http://admin:Aa123456!@59.110.46.39:9000/job/api1213/allure/widgets/suites.json"
        ...
        if self.error > 0:
            ...
            content = {
                ...
                "link": {
                    ...
                    "picUrl": "",
                    "messageUrl": "http://admin:Aa123456!@59.110.46.39:9000/job/api1213/allure/"
                }
            }
